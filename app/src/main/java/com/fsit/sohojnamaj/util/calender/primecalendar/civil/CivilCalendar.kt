package com.fsit.sohojnamaj.util.calender.primecalendar.civil

import com.aminography.primecalendar.civil.CivilCalendarUtils
import com.fsit.sohojnamaj.util.calender.primecalendar.base.BaseCalendar
...
class CivilCalendar @JvmOverloads constructor(
    ...
    override val monthName: String
        get() = internalCalendar.getDisplayName(MONTH, LONG, java.util.Locale( locale.toLanguageTag()))

    override val monthNameShort: String
        get() = internalCalendar.getDisplayName(MONTH, SHORT, java.util.Locale( locale.toLanguageTag()))

    override val weekDayName: String
        get() = internalCalendar.getDisplayName(DAY_OF_WEEK, LONG, java.util.Locale( locale.toLanguageTag()))

    override val weekDayNameShort: String
        get() = internalCalendar.getDisplayName(DAY_OF_WEEK, SHORT, java.util.Locale( locale.toLanguageTag()))
