package com.fsit.sohojnamaj.util.calender.primecalendar.english

import com.aminography.primecalendar.common.DateHolder
import com.fsit.sohojnamaj.util.calender.primecalendar.hijri.HijriCalendar.Companion.DEFAULT_LOCALE
import com.fsit.sohojnamaj.util.calender.primecalendar.hijri.HijriCalendar.Companion.dateAdjustingOffset
...
object EnglishCalendarUtils {
    ...
    internal val monthNamesEn = arrayOf(
        "January", // Muharram
        "February", // Safar
        "March", // Rabiʿ al-Awwal
        "April", // Rabiʿ ath-Thani
        "May", // Jumada al-Ula
        "June", // Jumada al-Akhirah
        "July", // Rajab
        "August", // Sha'ban
        "September", // Ramadan
        "October", // Shawwal
        "November", // Dhu al-Qa'dah
