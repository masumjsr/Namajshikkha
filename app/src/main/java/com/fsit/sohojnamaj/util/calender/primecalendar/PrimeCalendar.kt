...
abstract class PrimeCalendar(
     ...
     */
    protected var internalCalendar = GregorianCalendar(timeZone, java.util.Locale( locale.toLanguageTag()))
    ...
    fun getDisplayName(field: Int, style: Int, locale: Locale): String? {
        ...
        val symbols = DateFormatSymbols.getInstance(java.util.Locale( locale.toLanguageTag()))
