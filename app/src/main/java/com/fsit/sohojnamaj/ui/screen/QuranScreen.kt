...
@Composable
fun QuranScreen(onBackClick: () -> Unit, sura: List<Sura>, onSuraClick: (Int,String) -> Unit) {
    Scaffold (
        topBar = {
            TopAppBar (
                title = { Text(text = "আল-কুরআন")},
                navigationIcon = {
...
fun QuranScreenPreview() {
    QuranScreen(onBackClick={}, sura = sampleSura, onSuraClick = {_,_->})
}